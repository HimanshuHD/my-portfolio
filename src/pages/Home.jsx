...
export default function Home() {
  return <>
    <section className="hero"><div className="hero-grid"><div className="hero-copy"><div className="eyebrow"><span className="dot" /> Available for the right challenge</div><h1>Building digital<br /><em>experiences</em> that matter.</h1><p className="hero-text">I'm Himanshu — a Technology Lead and Frontend Engineer turning complex product ideas into fast, scalable and delightful web experiences.</p><div className="hero-actions"><Link className="button primary" to="/work">Explore my work <ArrowUpRight size={18} /></Link><Link className="button ghost" to="/contact">Get in touch</Link></div></div><div className="hero-art" aria-hidden="true"><div className="orb orb-a" /><div className="orb orb-b" /><div className="code-card"><span>const</span> engineer = {'{'}<br /><b>  focus:</b> 'impact',<br /><b>  craft:</b> 'frontend',<br /><b>  mindset:</b> 'systems'<br />{'}'};</div></div></div><div className="scroll-note">EXPLORE THE PORTFOLIO <span>↓</span></div></section>
