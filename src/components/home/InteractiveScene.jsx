...
function Phone() { return <group position={[-1.48, DESK_TOP + 0.024, 1.45]} rotation={[0.0257, -0.15, -0.00214]}><RoundedBox args={[0.64, 0.05, 1.18]} radius={0.02} smoothness={8} castShadow><meshStandardMaterial color="#171a1c" metalness={0.78} roughness={0.2} /></RoundedBox><mesh position={[0, 0.047, 0]} rotation={[-Math.PI / 2, 0, 0]}><planeGeometry args={[0.5, 0.96]} /><meshStandardMaterial color="#172c3a" emissive="#0a3842" emissiveIntensity={1.0} /></mesh></group>; }
