...
function Sticker({ sticker }) {
  ...
  // Sticker centers are positioned just outside the corresponding cube face.
  // Using the cube half-size here keeps all six faces aligned with the same shell
  // instead of leaving them recessed into the black body.
